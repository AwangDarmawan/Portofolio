  ...
  return (
    <>
            ...
            <div className='container bg-gray-300 px-3 border-b-2  border-gray-200 rounded-lg shadow-sm '>
                <h1 className=' text-center text-4xl  text-gray-900  font-black'>
                    MY PROJECTS</h1>
                <div className='grid grid-cols-12 my-5'>
                       ...
                       Sims PPOB is an application specifically designed for digital payment transaction tools.</span>
                        ...
                        flex flex-items-center gap-2 font-poppins font-bold bg-green-500 hover:bg-green-200  w-16 rounded-xl  text-white my-3'>
                ...
                <div className='col-span-12 lg:col-span-4 md:col-span-4 py-5 px-3'>
                 ...
                 <h3 className='text-xl  text-gray-900  font-black '>Design Portfolio (PDF)</h3>
             <a 
             href="https://drive.google.com/file/d/1Ecs8QFhEnjSMo7VT1vk8N2SaZxsV3dQe/view?usp=drivesdk" 
             download 
             className='flex items-center gap-2 font-poppins font-bold bg-green-500 hover:bg-green-200  w-fit px-4 py-2 rounded-xl text-white mt-2'
            >
